...
struct PropagationSettings {
    ...
    int num_eval_per_step;    // Total RK45 evaluations per [t_k, t_{k+1}]
    int num_subintervals = 10; // Number of subintervals (each resamples lambda)
